...
class CreateStoreWeaponsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_weapons', function (Blueprint $table) {
...
//	        $table->foreign('user_id_name')->references('id')->on('users');
    ...
    {
        Schema::dropIfExists('store_weapons');
    }
}
